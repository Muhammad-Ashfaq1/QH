            ...
            <div class="col-12 col-lg-6 col-xl-7">
                <div class="row justify-content-xl-center gx-0 p-3">
                    <div class="col-12 col-xl-11">
                        ...
                        <p class="lead fs-4 text-secondary mb-3">We are committed to illuminating lives and spaces
                            through our exceptional lighting solutions. Our focus is on delivering quality products and
                            outstanding services to our customers.</p>
                        <p class="mb-5">As a rapidly growing company, we remain dedicated to our core values of
                            innovation, sustainability, and customer satisfaction. We continuously strive to enhance our
                            offerings and exceed the expectations of our clients.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 col-xl-11">
                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p>
                                        <a class="link-secondary text-decoration-none fs-4" href="mailto:Orionlightingpvtltd@gmail.com">Orionlightingpvtltd@gmail.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>
